...
namespace config
{
  ...
  uint16_t const P2P_DEFAULT_PORT = 17680;
  uint16_t const RPC_DEFAULT_PORT = 17681;
  uint16_t const ZMQ_RPC_DEFAULT_PORT = 17682;
  boost::uuids::uuid const NETWORK_ID = { {
      0x12 ,0x30, 0xF1, 0x71 , 0x61, 0x07 , 0x41, 0x61, 0x17, 0x31, 0x70, 0x72, 0x18, 0xA9, 0xB1, 0x17
    } }; // Bender's nightmare
